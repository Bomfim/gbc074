...
class VoteRequester extends Requester {
    ...
    @Override
    public void run() {
        this.prm.logger.debug("Sending request vote to " + port);
        ...
        this.prm.logger.debug("Response to request vote is "+resp.toString());
        if (resp.get("error")!=null)
            this.prm.logger.debug("Error from request vote");
        else {
