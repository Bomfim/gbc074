...
public class RaftServer extends CServer {
    ...
    * Eventually we can implement this class behind a web server
    ...
    public static final int SEND_TIMEOUT = 2000; //25000,2000; // waiting time to connect with other server
    ...
    private int electionTimeout = 2000; //25000,2000 initialize to 5 seconds without a heartbeat => new election
    private int heartBeatPeriod = 250; //25000,250 time between leader's heartbeats
    ...
    protected void process() {
        ...
        if(message.get("isUser") == null) {
            ...
            if (message.get("isReporter") != null) {
